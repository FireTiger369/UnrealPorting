...
namespace UnrealPorting
{
    public partial class SettingsWindow : Window
    {
        ...
        private void BtnSave_Click(object sender, RoutedEventArgs e)
        {
            ...
            // Save engine version STRING
            profile.EngineVersion =
                (EngineComboBox.SelectedItem as ComboBoxItem)?.Content.ToString() ?? "";

            // ⭐ CRITICAL FIX: Save the engine version INDEX
            profile.EngineVersionIndex = EngineComboBox.SelectedIndex;
